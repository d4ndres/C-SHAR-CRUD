...
namespace _02_learn_entity_framework_core.Migrations
{
    ...
    [Migration("20230420022441_InitialDataInModels")]
    partial class InitialDataInModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_02_learn_entity_framework_core.Models.Tarea", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = new Guid("766970ac-6a58-4c4d-b9b3-f9ccfd976e94"),
                            FechaCreacion = new DateTime(2023, 4, 19, 21, 24, 40, 870, DateTimeKind.Local).AddTicks(1501),
                            PrioridadTarea = 1,
                        ...
                        new
                        {
                            ...
                            CategoriaId = new Guid("766970ac-6a58-4c4d-b9b3-f9ccfd976e94"),
                            FechaCreacion = new DateTime(2023, 4, 19, 21, 24, 40, 870, DateTimeKind.Local).AddTicks(1516),
                            PrioridadTarea = 0,
                            Titulo = "Ver pelicula"
                        });
                });
